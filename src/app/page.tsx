...
import fwxImage from '@/images/work/fwx.png'
...
function Resume () {
  ...
  return (
    <div
      ...
      <Button download={'Passakon_Puttasuwan_CV.pdf'} target={'_blank'} href="/cv.pdf" variant="secondary" className="group mt-6 w-full">
        Download CV
        <ArrowDownIcon
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Passakon, Experienced Full Stack Engineer with extensive
            expertise in backend development using Golang and frontend
            development with Vue.js/Nuxt.js. Proven track record in implementing
            DevOps practices and building scalable enterprise solutions. Strong
            focus on system architecture, code quality, and automated deployment
            pipelines.
          </p>
