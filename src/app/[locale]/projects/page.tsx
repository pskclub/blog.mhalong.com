...
const projects = [
  {
    name: 'mine-core',
    description:
      'A comprehensive Golang library that provides essential building blocks for web applications, including HTTP server management, database connectivity, authentication system, file handling, and notifications.',
    link: {
      href: 'https://github.com/pskclub/mine-core',
  ...
  },
  {
    ...
    logo: 'https://chords.mhalong.com/logo.png',
  }
]
